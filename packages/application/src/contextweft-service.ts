...
export class ContextWeftService {
  ...
  public async createCheckpoint(input: CreateCheckpointInput): Promise<CheckpointResult> {
    ...
    /* v8 ignore next -- @preserve #checkpointEvents always appends checkpoint.created last. */
    ...
    /* v8 ignore next -- @preserve checkpoint generation currently never emits memory events. */
